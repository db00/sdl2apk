...
showfont:  An example of using the SDL_ttf library with 2D graphics.
 gcc -Wall -I"../SDL2/include/" -I"../SDL2_ttf"  showfont.c SDL2_ttf.c -lSDL2 -Ddebug && a c:/WINDOWS/Fonts/simkai.ttf
 gcc -Wall -I"../SDL2/include/" -I"../SDL2_ttf"  showfont.c -lmingw32 -lSDL2_ttf -lSDL2_test -lSDL2main -lSDL2 -Ddebug && a c:/WINDOWS/Fonts/simkai.ttf
