/*
 * SDL2:
 gcc cmdutils.c ffplay.c -lSDL2 -I"$ANDROID_NDK/sources/ffmpeg/android/arm/include/"  -I"../SDL2/include/" -lm -L"/usr/local/lib/" -l"avformat" -l"avcodec" -l"avutil" -l"swresample" -l"avfilter" -l"swscale" -l"avdevice" -lpthread -lz  && ./a.out a.flv
 gcc -Wall cmdutils.c ffplay.c -lSDL2 -L"/usr/local/lib/" -I"/usr/local/include/" -I"/usr/include/SDL2/" -lm -l"avformat" -l"avcodec" -l"avutil" -l"swresample" -l"avfilter" -l"swscale" -l"avdevice" -lpthread -lz -llzma  && ./a.out ~/030002020055A4DD8370D905017057DB4BF4F8-B0B0-155E-13DD-09990A5A4573.flv
 * not available already:
 gcc cmdutils.c ffplay.c -lSDL2 -I"/usr/include/ffmpeg/"  -I"/usr/include/SDL2/" -lm -l"avformat" -l"avcodec" -l"avutil" -l"swresample" -l"avfilter" -l"swscale" -l"avdevice" && ./a.out a.flv
 gcc ffplay.c cmdutils.c sprite.c array.c ease.c matrix.c tween.c -L"lib" -lavdevice -lavcodec -lavformat -lavutil -lswscale -lswresample -lavfilter -D test_video -I"../SDL2/include" -I"include" -lpthread -lmingw32 -lSDL2main -lSDL2 && a a.flv

 * SDL1:
 gcc -Wall cmdutils.c ffplay.c -lSDL -L"/usr/local/lib/" -I"/usr/local/include" -I"/usr/include/SDL/" -lm -l"avformat" -l"avcodec" -l"avutil" -l"swresample" -l"avfilter" -l"swscale" -l"avdevice" -lpthread -lz -llzma && ./a.out ~/030002020055A4DD8370D905017057DB4BF4F8-B0B0-155E-13DD-09990A5A4573.flv
...
#if SDL_VERSION_ATLEAST(2,0,0)
static SDL_Surface * avframe2surface(VideoState * video,AVFrame * pFrame)
{
	int align=1;
	...
	//video->img_convert_ctx = sws_getContext(
	...
	if(video->img_convert_ctx == NULL)
	{
		fprintf(stderr, "Cannot initialize the conversion context!\n");
		exit(1);
	}
	sws_scale(video->img_convert_ctx,
			(void*)pFrame->data, pFrame->linesize, 0, pFrame->height,
...
#else
				SDL_PeepEvents(&event, 1, SDL_GETEVENT, SDL_EVENTMASK(FF_ALLOC_EVENT)) != 1
#endif
		   ) {
...
#if SDL_VERSION_ATLEAST(2,0,0)
	vp->bmp = avframe2surface(is,src_frame);
#endif
	...
	if (vp->bmp) {
...
#else
		{
			...
			if (e) {
				...
				int ret = av_opt_eval_flags(&class, o, e->value, (void*)&sws_flags);
				if (ret < 0)
					exit(1);
			}
		}
		...
		sws_scale(is->img_convert_ctx, (void*)src_frame->data, src_frame->linesize,
				0, vp->height, (void*)data, linesize);
#endif
...
#endif
#if SDL_VERSION_ATLEAST(2,0,0)
		//SDL_Texture * texture= SDL_CreateTexture(renderer, SDL_PIXELFORMAT_IYUV, SDL_TEXTUREACCESS_STREAMING, src_frame->width,src_frame->height);  
		//SDL_UpdateTexture(texture, NULL, src_frame->data, src_frame->linesize[0]);

		//SDL_UpdateYUVTexture(texture, NULL, src_frame->data[0], src_frame->linesize[0], src_frame->data[1], src_frame->linesize[1], src_frame->data[2], src_frame->linesize[2]);
		//printf("===\n");
#endif
		vp->pts = pts;
...
#if !defined(_WIN32) && !defined(__APPLE__) && !SDL_VERSION_ATLEAST(2,0,0)
