/***
 *
 gcc -D _DEBUG_ZSTREAM -I"include" httpz.c -lz && ./a.out
 gcc -D _DEBUG_ZSTREAM -I"include" httpz.c adler32.c inftrees.c inffast.c crc32.c zutil.c inflate.c         deflate.c trees.c  && ./a.out
 */
#include <stdio.h>
#include <stdlib.h>
#include <string.h>
