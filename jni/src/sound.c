/** 
 *
 gcc sound.c -I"../SDL2/include" -I"/usr/include/ffmpeg/" -L"/usr/lib/" -lm -lpthread -lSDL2 -lswresample -lavdevice -lavcodec -lavformat -lavutil -lswscale && ./a.out
 gcc sound.c -I"../SDL2/include" -lSDL2 -lavdevice -lavcodec -lavformat -lavutil -lswscale -lswresample -lavdevice && ./a.out 
...
{  
	...
	ifmt = av_find_input_format("alsa"); url = "default";
	if(avformat_open_input(&pFormatCtx,url,ifmt,NULL)!=0){
