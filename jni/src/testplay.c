/*
 * 
 gcc testplay.c -lSDL2 -I"/usr/include/ffmpeg/" -I"/usr/include/SDL2/" -lm -l"avformat" -l"avcodec" -l"avutil" -l"swresample" -l"avfilter" -l"swscale" -l"avdevice" && ./a.out a.flv
 gcc testplay.c -lSDL2 -I"/usr/include/ffmpeg/" -I"/home/libiao/src/android-ndk-r10/sources/ffmpeg/android/arm/include/" -I"/usr/include/SDL2/" -lm -l"avformat" -l"avcodec" -l"avutil" -l"swresample" -l"avfilter" -l"swscale" -l"avdevice" && ./a.out a.flv
 *
