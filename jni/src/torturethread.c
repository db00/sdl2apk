/*
 ...
 gcc torturethread.c -I"../SDL2/include/" -I"../SDL2_ttf/"   -lSDL2_test -lSDL2 -lSDL2_ttf -lSDL2_image && ./a.out
 gcc torturethread.c -I"../SDL2/include/" -I"../SDL2_ttf/"  -lmingw32 -lSDL2_test -lSDL2main -lSDL2 -lSDL2_ttf -lSDL2_image && a
